...
Puz.prototype = {
	...
	init: function () {
		...
		this.board_wrapper_el = document.getElementById(this.board_wrapper_id);
		// if this is null, attach a div with the ID
		if (!this.board_wrapper_el) {
			this.board_wrapper_el = document.createElement('div');
			this.board_wrapper_el.setAttribute("id", this.board_wrapper_id);
			body = document.getElementsByTagName('body')[0];
			body.appendChild(this.board_wrapper_el);
		}
